...
function PaymentMethodCard({ pm }: { pm: PaymentMethod }) {
  ...
  return (
    <motion.div
      ...
      className="relative overflow-hidden rounded-xl border border-neutral-200 bg-white p-4 transition hover:border-neutral-400"
    >
      ...
      {!pm.is_valid && (
        <div className="mt-3 rounded-lg bg-red-50 px-2.5 py-1.5 text-xs text-red-700">
