...
export default function FileUploadStep({ data, onComplete, form }: FileUploadStepProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {uploadData.isValid && (
        <Card>
          <CardContent className="p-6">
            <h4 className="font-semibold text-gray-900 mb-4">3D Preview</h4>
            <div className="aspect-video bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center">
              <div className="text-center">
                <div className="w-16 h-16 bg-gray-300 rounded-lg mx-auto mb-4"></div>
                <p className="text-gray-600 mb-2">3D preview will appear here</p>
